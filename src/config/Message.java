...
public class Message {
	...
	public static final String REGISTER_SUCCESS = GREEN + "registered successfully...";
	public static final String REGISTER_FAILED = "failed to register...";
	public static final String SIGNIN_SUCCESS = GREEN + "signin successfully...";
	public static final String SIGNIN_FAILED = "failed to signin...";
	public static final String ACCOUNT_BLOCKS = "your account is blocked...";
	...
	public static final String SUCCESS = GREEN + "success...";
}
